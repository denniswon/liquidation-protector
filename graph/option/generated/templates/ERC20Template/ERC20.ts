...
export class ERC20 extends ethereum.SmartContract {
  ...
  canRedeem(redeemer: Address): boolean {
    let result = super.call("canRedeem", "canRedeem(address):(bool)", [
  ...
  try_canRedeem(redeemer: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("canRedeem", "canRedeem(address):(bool)", [
      ethereum.Value.fromAddress(redeemer)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
